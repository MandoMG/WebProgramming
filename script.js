...
document.addEventListener('DOMContentLoaded', function () {
      ...
      self = {
         ...
         startGame: function (playerCount) {
            ...
            if (playerCount >= 1) {
               ...
               for (whichPlayer = 0; whichPlayer < playerCount; whichPlayer += 1) {
                  state.scoreSheet[whichPlayer] = new Array(13).fill(-1);
               }
         ...
         score: function (scoreType) { //scoreType should be an integer from 0-12, in the order the categories are on the scoresheet
            ...
            if (scoreType === 0) {           //Ones
               ...
               dieResults.forEach(function (dieCount) {
                  if (dieCount === 2) {
                     twoFound = true;
                  } else if (dieCount === 3) {
                     threeFound = true;
   ...
   (function () {
      ...
      var updateView, rollButton, yahtzeeGame, selectedCategory;
